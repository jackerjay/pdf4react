...
var AnnotationLeftToolsMenu = function (_Component) {
	_inherits(AnnotationLeftToolsMenu, _Component);

	function AnnotationLeftToolsMenu(props) {
		_classCallCheck(this, AnnotationLeftToolsMenu);

		var _this = _possibleConstructorReturn(this, (AnnotationLeftToolsMenu.__proto__ || Object.getPrototypeOf(AnnotationLeftToolsMenu)).call(this, props));
	...
	_createClass(AnnotationLeftToolsMenu, [{
	...
	return AnnotationLeftToolsMenu;
}(_react.Component);

module.exports = AnnotationLeftToolsMenu;
//# sourceMappingURL=AnnotationLeftToolsMenu.js.map