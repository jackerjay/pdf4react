...
var _AnnotationViewModel = require('./AnnotationViewModel');

var _AnnotationViewModel2 = _interopRequireDefault(_AnnotationViewModel);
...
var AnnotationViewer = function (_Component) {
	...
	function AnnotationViewer(props) {
		...
		_this.handlePdfAnnotationModel = _this.handlePdfAnnotationModel.bind(_this);
		return _this;
	}
	...
	_createClass(AnnotationViewer, [{
		...
		key: 'handlePdfAnnotationModel',
		value: function handlePdfAnnotationModel() {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				this.state.viewModel ? _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_AnnotationViewModel2.default, {
